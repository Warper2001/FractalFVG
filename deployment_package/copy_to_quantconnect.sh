...
echo "🚀 MNQ FVG Individual Contract QuantConnect Deployment Helper"
echo "============================================================"
...
echo "2. Create new algorithm: MNQ_FVG_Individual_Contract_YTD2025"
...
echo ""
echo "🔧 NEW FEATURES:"
echo "• Individual futures contract trading (AddFutureContract)"
echo "• Automatic front-month contract selection"
echo "• Monthly contract rollover with position liquidation"
echo "• Contract-specific FVG detection and analysis"
echo ""
...
echo "• Reduced slippage with specific contracts"
